...
ALTER COLUMN last_login_at TYPE TIMESTAMPTZ USING 
    CASE 
        ...
        ELSE last_login_at AT TIME ZONE 'Asia/Seoul' 
    END;
...
BEGIN
    ...
    LOOP
        ...
        IF EXISTS (
            ...
            EXECUTE format('ALTER TABLE %I ALTER COLUMN created_at TYPE TIMESTAMPTZ USING created_at AT TIME ZONE ''Asia/Seoul''', 
        ...
        IF EXISTS (
            ...
            EXECUTE format('ALTER TABLE %I ALTER COLUMN updated_at TYPE TIMESTAMPTZ USING updated_at AT TIME ZONE ''Asia/Seoul''', 
                          table_record.table_name);
...
SELECT 
    ...
    timezone('Asia/Seoul', NOW()) as utc_time;
